...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'mobit', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'\\src\\Andrey\\crudBundle\\Resources\\config\\doctrine') => 'Andrey\\crudBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\Blog\\BlogBundle\\Entity'))), 'Blog\\BlogBundle\\Entity');
        $b->addDriver($a, 'Andrey\\crudBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('BlogBlogBundle' => 'Blog\\BlogBundle\\Entity', 'AndreycrudBundle' => 'Andrey\\crudBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_caeee3973b42985063c28df02926e96496fadc43cc34f368b5f4ceefbcb889c7');
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Blog\\BlogBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Andrey\\crudBundle/Resources/views'), 'Andreycrud');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AndreycrudBundle' => 'Andrey\\crudBundle\\AndreycrudBundle',
            ...
            'mailer_user' => 'Dren9446',
            'mailer_password' => 123,
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'blog_blog.emails.contact_email' => 'contact@email.com',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'Dren9446',
